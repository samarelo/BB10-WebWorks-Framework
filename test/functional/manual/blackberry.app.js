    ...
    describe("window covers", function () {
        ...
        it("sets window cover from file:///filepath", function () {
            var confirm,
                cover = {
                    "cover": {
                        "type": blackberry.app.cover.TYPE_FILE,
                        "path": "file:///accounts/1000/shared/downloads/windowcover.png"
                    },
                    "text": [{"label": "Test 1", "size": 8}],
                },
                flag = false,
                blob,
        ...
        it("sets window cover with text wrapping", function () {
            var confirm,
                cover = {
                    "cover": {
                        "type": blackberry.app.cover.TYPE_FILE,
                    ...
                    "text": [{"label": "This is a long label that should wrap text to the next line", "size": 8, "wrap": true}],
                },
                description = "type: file\n" +
                              "image: windowcover.png\n" +
                              "label: This is a long label that should wrap test to the next line\n" +
                              "wrap: yes\n";
            entercover = function () {
                blackberry.app.updateCover(cover);
            };
        ...
        it("sets window cover without text wrapping", function () {
            var confirm,
                cover = {
                    "cover": {
                        "type": blackberry.app.cover.TYPE_FILE,
                    ...
                    "text": [{"label": "This is a long label that should not wrap text to the next line", "size": 8, "wrap": false}],
                },
                description = "type: file\n" +
                              "image: windowcover.png\n" +
