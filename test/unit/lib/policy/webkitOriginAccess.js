...
describe("lib/policy/webkitOriginAccess", function () {
    ...
    describe("addWebview function", function () {
        ...
        it("initializes the webview with whitelisting based on the config", function () {
            ...
            expect(mockWebView.addOriginAccessWhitelistEntry).toHaveBeenCalledWith(LOCAL_URI, mockContent, false);
            ...
            expect(mockWebView.addOriginAccessWhitelistEntry).toHaveBeenCalledWith(mockAccessList[0].uri, mockContent, false);
        });
