...
function _formMessage(url, origin, sid, body, securityOrigin) {
    ...
    return {
        ...
        response : {
            send : function (code, data) {
                ...
                _webview.notifyHeaderReceived(sid, "Access-Control-Allow-Origin", securityOrigin);
...
function networkResourceRequestedHandler(value) {
    ...
    if (url.match("^" + utils.getURIPrefix())) {
        ...
        message = _formMessage(url, origin, sid, body, securityOrigin);
