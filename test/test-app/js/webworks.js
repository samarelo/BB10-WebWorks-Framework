...
module.exports = {
	hash: "7b5f096196819cba77fd991540d05de7",
	version: "1.0.0.7"
};
});
/*
...
(function () {
    ...
    function createWebworksReady() {
        var _prefix = require("lib/utils").getURIPrefix(),
            builder,
            request,
            resp,
            execFunc,
        ...
        request.open("GET", _prefix + "extensions/get/?hash=" + wwInfo.hash + "&version=" + wwInfo.version, true);
