describe("White listing", function () {
    ...
    describe("allowing access to domains", function () {
        ...
        var whitelistedDomain = "rim.internaldomain.com";
        ...
        describe("with url parameters", function () {
            ...
            it("can append params to a path whitelisted with ?*", function () {
                testXhrGetLoadsUrl("http://rim3.internaldomain.com/index.html?a=b&c=d&v=" + generateSerial());
            });

            it("cannot append params to a path whitelisted without ?*", function () {
                testXhrGetFailsToLoadUrl("http://rim4.internaldomain.com/index.html?a=b&c=d&v=" + generateSerial());
            });
        });
    ...
    describe("disallowing access to domains", function () {
        ...
        var blacklistedDomain = "rim2.internaldomain.com";
        ...
        describe("at specific paths", function () {
            it("can access /a/index.html", function () {
                testXhrGetLoadsUrl("http://rim4.internaldomain.com/a/index.html");
            });
            it("cannot access sibling folder /b/index.html", function () {
                testXhrGetFailsToLoadUrl("http://rim4.internaldomain.com/b/index.html");
            });
        });
    });
    ...
    describe("allowing access to subdomains", function () {
        ...
        var whitelistedSubdomain = "www.rim.internaldomain.com";
        ...
        it("can follow a redirect", function () {
            testXhrGetLoadsUrl('http://rim.internaldomain.com/redirect.php?url=' + encodeURIComponent('http://rim1.internaldomain.com/index.html'));
        });
    });
    ...
    describe("disallowing access to subdomains", function () {
        ...
        var blacklistedSubdomain = "www.rim1.internaldomain.com";
        ...
        it("defaults to disallowing subdomains", function () {
            testXhrGetFailsToLoadDocument('www.rim5.internaldomain.com');
        });
        ...
        describe("explicitly allowed subdomains", function () {
            ...
            it("explicitly allows subdomains", function () {
                testXhrGetLoadsDocument('www.rim6.internaldomain.com');
            });
            ...
            it("disallows subdomains not explicitly permitted", function () {
                testXhrGetFailsToLoadDocument('www2.rim6.internaldomain.com');
            });
        });
    });
    ...
    describe("allowing access to web api on subdomains", function () {
        ...
        it("allows web api access explicitly set on a subdomain", function () {
            testExternalWebApiRuns('www.rim7.internaldomain.com');
        });
        ...
        it("allows web api access explicitly set on a folder", function () {
            testHtmlElementLoads('iframe', {src: 'http://rim8.internaldomain.com/a/webworks.html' });
            testExternalWebApiRuns('rim8.internaldomain.com', '/a/webworks.html');
        });
    });
    ...
    describe("Cross Origin Request", function () {
        ...
        describe("Within an iFrame", function () {
            ...
            xit("should NOT allow navigation for a non-whitelisted domain", function () {
                var url = "http://rim2.internaldomain.com/",
                    oddJob = jasmine.createSpy();
                ifr.src = url;
                ifr.onerror = oddJob;
                ifr.sandbox = "allow-same-origin allow-scripts";
